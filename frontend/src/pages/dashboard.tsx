...
const Dashboard = () => {
  ...
  const [email_accounts, setEmail_accounts] = React.useState('Loading...');
  const [emails, setEmails] = React.useState('Loading...');
  const [organizations, setOrganizations] = React.useState('Loading...');
  const [suggested_responses, setSuggested_responses] =
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_EMAIL_ACCOUNTS') && (
            <Link href={'/email_accounts/email_accounts-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiEmail || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiEmailOpen || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_SUGGESTED_RESPONSES') && (
            <Link href={'/suggested_responses/suggested_responses-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiMessageReplyText || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
