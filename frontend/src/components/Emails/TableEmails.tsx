...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/emails/emailsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureEmailsCols';
...
const TableSampleEmails = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (emailsNotify.showNotification) {
      notify(emailsNotify.typeNotification, emailsNotify.textNotification);
    }
  }, [emailsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/emails/emails-view/?id=${id}`);
  };
...
export default TableSampleEmails;
