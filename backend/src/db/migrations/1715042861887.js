module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('suggested_responses', 'emailId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('emails', 'email_accountId', {
        transaction,
      });

      await queryInterface.removeColumn('emails', 'received_at', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('email_accounts', 'userId', {
        transaction,
      });

      await queryInterface.removeColumn('email_accounts', 'password', {
        transaction,
      });

      await queryInterface.removeColumn('email_accounts', 'email_address', {
        transaction,
      });

      await queryInterface.removeColumn('email_accounts', 'email_provider', {
        transaction,
      });
      ...
      await queryInterface.dropTable('suggested_responses', { transaction });

      await queryInterface.dropTable('organizations', { transaction });

      await queryInterface.dropTable('emails', { transaction });

      await queryInterface.dropTable('email_accounts', { transaction });
