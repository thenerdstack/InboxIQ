...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_EMAIL_ACCOUNTS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_EMAIL_ACCOUNTS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_EMAIL_ACCOUNTS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_EMAIL_ACCOUNTS'),
      },
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_SUGGESTED_RESPONSES'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_SUGGESTED_RESPONSES'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_SUGGESTED_RESPONSES'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_SUGGESTED_RESPONSES'),
      },
